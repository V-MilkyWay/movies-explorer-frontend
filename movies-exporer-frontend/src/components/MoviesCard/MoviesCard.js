...
function MoviesCard(props) {
    ...
    return (
        <div className="moviesCard">
            ...
            <button className={props.buttonLike === true ? (like === true ? 'moviesCard__like moviesCard__like_active' : 'moviesCard__like') : 'moviesCard__like_hidden'} type="button" onClick={handleClick} content='Сохранить'></button>
